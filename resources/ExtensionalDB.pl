...
clause1(type(roleClassLib_1,roleClassLib),true).
clause1(hasRoleClass(roleClassLib_1,roleClass_1),true).
clause1(type(roleClassLib_2,roleClassLib),true).
...
clause1(type(roleClass_2,roleClass),true).
clause1(hasAttribute(roleClass_2,attribute_2),true).
clause1(hasAttribute(roleClass_2,attribute_3),true).
clause1(roleClassRefSem(roleClass_2,eClassSpecification_2),true).
clause1(type(roleClass_1,roleClass),true).
clause1(hasAttribute(roleClass_1,attribute_1),true).
clause1(roleClassRefSem(roleClass_1,eClassSpecification_1),true).


clause1(type(roleClass_2,internalElement),true).
clause1(hasAttribute(roleClass_2,attribute_2),true).
clause1(hasAttribute(roleClass_2,attribute_3),true).
clause1(roleClassRefSem(roleClass_2,eClassSpecification_2),true).
clause1(type(roleClass_1,internalElement),true).
clause1(hasAttribute(roleClass_1,attribute_1),true).
clause1(roleClassRefSem(roleClass_1,eClassSpecification_1),true).

clause1(type(state,changeMode),true).
clause1(type(change,changeMode),true).
clause1(type(create,changeMode),true).

clause1(type(cAEXFile_1,cAEXFile),true).
clause1(hasRoleClassLib(cAEXFile_1,roleClassLib_1),true).
clause1(type(cAEXFile_2,cAEXFile),true).
clause1(hasRoleClassLib(cAEXFile_2,roleClassLib_2),true).

clause1(type(eClassSpecification_1,eClassSpecification),true).
...
clause1(type(eClassSpecification_2,eClassSpecification),true).
